...
struct int8_4
{
  ...
  __device__ int8_4() {}
  __device__ int8_4(const int8_t & val)
...
struct uint8_4
{
  ...
  __device__ uint8_4() {}
  __device__ uint8_4(const uint8_t & val)
  : x(val), y(val), z(val), w(val) {
  }
...
struct int8_2
{
  int8_t x = 0, y = 0;
  __device__ int8_2() {}
  __device__ int8_2(const int8_t & val)
  : x(val), y(val) {
  }
  __device__ int8_2(const int8_t & x, const int8_t & y)
  : x(x), y(y) {
  }
};
...
struct uint8_2
{
  uint8_t x = 0, y = 0;
  __device__ uint8_2() {}
  __device__ uint8_2(const uint8_t & val)
  : x(val), y(val) {
  }
  __device__ uint8_2(const uint8_t & x, const uint8_t & y)
  : x(x), y(y) {
  }
};
...
struct int32_4
{
  ...
  __device__ int32_4() {}
  __device__ int32_4(const int32_t & val)
  : x(val), y(val), z(val), w(val) {
  }
};
...
struct float_4
{
  ...
  __device__ float_4() {}
  __device__ float_4(const float & val)
  : x(val), y(val), z(val), w(val) {
  }
};
